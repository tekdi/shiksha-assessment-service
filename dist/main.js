...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.HelperUtil = exports.ValidateDatetimeConstraints = void 0;
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
let ValidateDatetimeConstraints = class ValidateDatetimeConstraints {
    validate(endDateValue, args) {
        const startDateStr = args.object.startDate;
        if (!startDateStr)
            return true;
...
exports.ValidateDatetimeConstraints = ValidateDatetimeConstraints;
exports.ValidateDatetimeConstraints = ValidateDatetimeConstraints = __decorate([
    (0, class_validator_1.ValidatorConstraint)({ name: 'validateDatetimeConstraints', async: false })
], ValidateDatetimeConstraints);
class HelperUtil {
    static generateAlias(title) {
        if (!title)
            return '';
        return title
            .toLowerCase()
    ...
    static async generateUniqueAliasWithRepo(title, repository, tenantId, organisationId) {
...
const class_validator_1 = __webpack_require__(/*! class-validator */ "class-validator");
const test_entity_1 = __webpack_require__(/*! ../entities/test.entity */ "./src/modules/tests/entities/test.entity.ts");
const helper_util_1 = __webpack_require__(/*! @/common/utils/helper.util */ "./src/common/utils/helper.util.ts");
class CreateTestDto {
}
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)(),
    (0, class_validator_1.Validate)(helper_util_1.ValidateDatetimeConstraints),
    __metadata("design:type", String)
...
exports.RulesController = RulesController = __decorate([
    ...
    (0, common_2.UseInterceptors)(auth_context_interceptor_1.AuthContextInterceptor),
...
let TestsService = class TestsService {
    ...
    async create(createTestDto, authContext) {
        ...
        if (!createTestDto.alias) {
            createTestDto.alias = await helper_util_1.HelperUtil.generateUniqueAliasWithRepo(createTestDto.title, this.testRepository, authContext.tenantId, authContext.organisationId);
        }
        else {
            const existingTest = await this.testRepository.findOne({
                where: {
                    ...
                    tenantId: authContext.tenantId,
                    organisationId: authContext.organisationId,
                    status: (0, typeorm_2.Not)(test_entity_2.TestStatus.ARCHIVED)
                },
            });
            if (existingTest) {
                const originalAlias = createTestDto.alias;
                createTestDto.alias = await helper_util_1.HelperUtil.generateUniqueAliasWithRepo(originalAlias, this.testRepository, authContext.tenantId, authContext.organisationId);
            }
        }
